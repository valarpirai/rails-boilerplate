...
module FlagManager
  class DSL
    ...
    #
    # name - The String or Symbol name of the feature.
    # actor - a FlagManager::Types::Actor instance or an object that responds
    #         to FlagManager_id.
    #
    ...
    #
    # name - The String or Symbol name of the feature.
    # group - a FlagManager::Types::Group instance or a String or Symbol name of a
    #         registered group.
    #
    # Returns result of Feature#enable.
    ...
    #
    # name - The String or Symbol name of the feature.
    # percentage - a FlagManager::Types::PercentageOfTime instance or an object
    ...
    #
    # name - The String or Symbol name of the feature.
    # percentage - a FlagManager::Types::PercentageOfActors instance or an object
    #              that responds to to_i.
    #
    # Returns result of Feature#enable.
    ...
    # name - The String or Symbol name of the feature.
    #
    # Returns an instance of FlagManager::Feature.
    def feature(name)
    ...
    #
    # Returns an Array of FlagManager::Feature.
    def preload(names)
    ...
    #
    # Returns a FlagManager::Types::Boolean instance.
    ...
    # Public: Access a FlagManager group by name.
    #
    # name - The String or Symbol name of the feature.
    #
    # Returns an instance of FlagManager::Group.
    def group(name)
      FlagManager.group(name)
    end

    # Public: Wraps an object as a FlagManager actor.
    #
    # thing - The object that you would like to wrap.
    #
    # Returns an instance of FlagManager::Types::Actor.
    # Raises ArgumentError if thing does not respond to `FlagManager_id`.
    def actor(thing)
    ...
    #
    # Returns FlagManager::Types::PercentageOfTime.
    def time(number)
    ...
    #
    # Returns FlagManager::Types::PercentageOfActors.
    def actors(number)
    ...
    #
    # Returns Set of FlagManager::Feature instances.
    def features
      adapter.features.map { |name| feature(name) }.to_set
    end

    def import(FlagManager)
      adapter.import(FlagManager.adapter)
    end
